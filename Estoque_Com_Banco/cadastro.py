    ...
    # Criar Tabelas
        ...
        self.cursor.execute(""" 
                            CREATE TABLE IF NOT EXISTS "saida" (
                                    ...
                                    "numero_os"	INTEGER,
                                    PRIMARY KEY("id_saida" AUTOINCREMENT)
                                )
                            """)

        self.cursor.execute(""" 
                            CREATE TABLE IF NOT EXISTS "tbr_material_saida" (
                                "id"	INTEGER,
                                "id_cadastro"	INTEGER,
                                "id_saida"	INTEGER,
                                FOREIGN KEY("id_cadastro") REFERENCES "cadastro"("id_cadastro"),
        ...
        self.cursor.execute(""" 
                            CREATE TABLE IF NOT EXISTS "tbr_material_entrada" (
                                "id"	INTEGER,
                                "id_cadastro"	INTEGER,
                                "id_entrada"	INTEGER,
...
class Application(Funcoes_cadastro,Entrada,Saida,Estoque):
    def __init__(self,master=None):
        ...
        self.frames_saida()
        self.widgts_saida()
        self.lista_frame3_saida()
        self.lista_frame2_saida()

        self.frames_estoque()
        self.widgts_estoque()
        self.lista_frame3_estoque()
        self.lista_frame2_estoque()
    ...
    def frames_cadastro(self):
        ...
        self.aba4.configure(background='gray')
        
        self.abas.add(self.aba1,text='CADASTRO DE MATERIAL')
        self.abas.add(self.aba2,text='ENTRADA DE MATERIAL')
        self.abas.add(self.aba3,text='SAIDA DE MATERIAL')
        self.abas.add(self.aba4,text='ESTOQUE')
